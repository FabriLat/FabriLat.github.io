...
//agregar
let cartelInicio = cartelAmarillo
function ocultarMain(){
    cartelInicio.innerHTML = '<i class="fa fa-exclamation"></i>Seleccione los valores a filtrar presione click en el botón FILTRAR.'
    seccionContenido.style.visibility = "hidden";
    cartelInicio.style.display = "block";
}
...
async function consultarResultados() {
    if (await validarSelects()) {
        ...
        ocultarCarga();
        cartelAmarillo.style.display = "none"
        cartelAmarillo.innerHTML='<i class="fa fa-exclamation"></i>Los campos deben estar llenos para filtrar la información.'
